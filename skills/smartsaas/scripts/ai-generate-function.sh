#!/usr/bin/env bash
# Usage: ai-generate-function.sh <promptJson>
# Generate a utility function from a natural-language description. promptJson: {"textContent":"...", "language":"javascript"}
...
RES=$(curl $CURL_OPTS -w "\n%{http_code}" -X POST "${BASE}/api/ai/generate-function" \
