#!/usr/bin/env bash
# Usage: create-document-template.sh <templateJson>
#   Shape: DocumentTemplates.mjs. Required: title. Optional: content (HTML with {{{placeholders}}}), description, tags, isTemplate, global, checkBoxes, data.
