#!/usr/bin/env bash
# Usage: ai-generate-social-posts.sh <promptJson>
# Use AI to generate social media posts for a campaign or topic.
# promptJson: {"topic":"...", "campaignId":"...", "platforms":["linkedin","twitter"], "tone":"..."}
...
RES=$(curl $CURL_OPTS -w "\n%{http_code}" -X POST "${BASE}/api/ai/campaign-social-posts" \
