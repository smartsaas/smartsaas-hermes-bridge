#!/usr/bin/env bash
# Usage: get-competitor-strategy.sh <competitorId>
# Get the AI-generated strategy analysis for a competitor.
...
RES=$(curl $CURL_OPTS -w "\n%{http_code}" -X GET "${BASE}/api/competitors/${COMPETITOR_ID}/strategy" \
